...
The HW02 setup structure, AI documentation adaptation, and initial Domain Testing/BVA planning were assisted by Codex; I reviewed and modified the generated materials to match the EShop SUT requirements, the selected features FR-06, FR-10, FR-15, and Mobile FR-05, and the course requirement to submit AI-02 and AI-03. I confirm I did not use AI to generate any artifact listed in the prohibited category.
