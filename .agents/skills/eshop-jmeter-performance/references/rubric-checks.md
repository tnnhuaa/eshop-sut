...
The supplied rubric rows total 90 while the displayed total says 100. Preserve the rubric and flag the discrepancy for the TA; do not invent a missing ten-point criterion.
