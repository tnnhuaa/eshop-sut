...
- `terminal-final.png`: final CLI output with samples, failures, and resource peaks.
- `task-manager-during-run.png`: backend terminal, JMeter terminal, CPU, and physical RAM in the same frame.
- `jmeter-summary-report.png`: raw JTL loaded into the disabled GUI Summary Report after execution.
