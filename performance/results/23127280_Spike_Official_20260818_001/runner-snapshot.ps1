...
if ($RunId -ne "23127280_Spike_Official_20260818_001") {
    throw "RunId does not match the student's approved official Spike run"
}
...
& $node $seedScript "--users=20" "--max-uses=100" "--reset-id=$ResetId"
