...
| B | Order State Machine | FR-10 | API + Web User + Web Admin | Requirement analysis completed |
...
FR-10 test design should cover:
...
| Features with test cases designed | 1 |
| Test cases designed | 21 |
