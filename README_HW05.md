...
Current state: plans and supporting automation are being prepared; official evidence is `NOT_RUN`.
...
3. Run `scripts/preflight.ps1`; inspect all nine requests before measured traffic.
